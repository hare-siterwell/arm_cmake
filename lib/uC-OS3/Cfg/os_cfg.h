...
*
*                    Copyright 2009-2021 Silicon Laboratories Inc.
*www.silabs.com
*
...
#define OS_CFG_OBJ_TYPE_CHK_EN                                                 \
  1u /* Enable (1) or Disable (0) object type checking */
#define OS_CFG_OBJ_CREATED_CHK_EN                                              \
  1u                    /* Enable (1) or Disable (0) object created checks */
#define OS_CFG_TS_EN 0u /* Enable (1) or Disable (0) time stamping */

#define OS_CFG_PRIO_MAX                                                        \
  64u /* Defines the maximum number of task priorities (see OS_PRIO data type) \
       */

#define OS_CFG_SCHED_LOCK_TIME_MEAS_EN                                         \
  0u /* Include code to measure scheduler lock time */
#define OS_CFG_SCHED_ROUND_ROBIN_EN                                            \
  1u /* Include code for Round-Robin scheduling */

#define OS_CFG_STK_SIZE_MIN 64u /* Minimum allowable task stack size */

/* --------------------------- EVENT FLAGS ----------------------------- */
#define OS_CFG_FLAG_EN                                                         \
  1u /* Enable (1) or Disable (0) code generation for EVENT FLAGS */
#define OS_CFG_FLAG_DEL_EN 1u /*     Include code for OSFlagDel() */
#define OS_CFG_FLAG_MODE_CLR_EN                                                \
  1u /*     Include code for Wait on Clear EVENT FLAGS */
#define OS_CFG_FLAG_PEND_ABORT_EN                                              \
  1u /*     Include code for OSFlagPendAbort() */

/* ------------------------ MEMORY MANAGEMENT -------------------------  */
#define OS_CFG_MEM_EN                                                          \
  1u /* Enable (1) or Disable (0) code generation for the MEMORY MANAGER */

/* ------------------- MUTUAL EXCLUSION SEMAPHORES --------------------  */
#define OS_CFG_MUTEX_EN                                                        \
  1u /* Enable (1) or Disable (0) code generation for MUTEX */
#define OS_CFG_MUTEX_DEL_EN 1u /*     Include code for OSMutexDel() */
#define OS_CFG_MUTEX_PEND_ABORT_EN                                             \
  1u /*     Include code for OSMutexPendAbort() */

/* -------------------------- MESSAGE QUEUES --------------------------  */
#define OS_CFG_Q_EN                                                            \
  1u /* Enable (1) or Disable (0) code generation for QUEUES */
...
/* ------------------------- TIMER MANAGEMENT -------------------------- */
#define OS_CFG_TMR_EN                                                          \
  1u /* Enable (1) or Disable (0) code generation for TIMERS */
#define OS_CFG_TMR_DEL_EN                                                      \
  1u /* Enable (1) or Disable (0) code generation for OSTmrDel() */

/* ------------------------- TRACE RECORDER ---------------------------- */
#define OS_CFG_TRACE_EN                                                        \
  0u /* Enable (1) or Disable (0) uC/OS-III Trace instrumentation */
#define OS_CFG_TRACE_API_ENTER_EN                                              \
  0u /* Enable (1) or Disable (0) uC/OS-III Trace API enter instrumentation */
#define OS_CFG_TRACE_API_EXIT_EN                                               \
  0u /* Enable (1) or Disable (0) uC/OS-III Trace API exit  instrumentation */
