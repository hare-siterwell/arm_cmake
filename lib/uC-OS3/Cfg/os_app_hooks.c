...
*
* Arguments  : p_tcb   is a pointer to the task control block of the offending
*task. NULL if ISR.
*
* Note(s)    : None.
************************************************************************************************************************
...
*
* Description: This function is called every second by uC/OS-III's statistics
...
*
* Arguments  : p_tcb   is a pointer to the task control block of the task being
*created.
*
* Note(s)    : none
************************************************************************************************************************
...
void App_OS_TaskCreateHook(OS_TCB *p_tcb) { (void)p_tcb; }
...
void App_OS_TaskDelHook(OS_TCB *p_tcb) { (void)p_tcb; }
...
*
* Arguments  : p_tcb     is a pointer to the OS_TCB of the task that is
*returning.
*
* Note(s)    : none
************************************************************************************************************************
...
void App_OS_TaskReturnHook(OS_TCB *p_tcb) { (void)p_tcb; }
...
*              2) It is assumed that the global pointer 'OSTCBHighRdyPtr' points
*to the TCB of the task that will be 'switched in' (i.e. the highest priority
*task) and, 'OSTCBCurPtr' points to the task being switched out (i.e. the
*preempted task).
************************************************************************************************************************
*/
