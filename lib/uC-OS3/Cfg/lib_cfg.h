...
*
*               (b) When DISABLED, NO arguments received from any port interface
*provided by the developer or application are checked/validated.
*********************************************************************************************************
*/
...
*
* Note(s) : (1) Configure LIB_MEM_CFG_DBG_INFO_EN to enable/disable memory
*allocation usage tracking that associates a name with each segment or dynamic
*pool allocated.
*
...
*
*                   (1) Heap initialized to specified application memory, if
*LIB_MEM_CFG_HEAP_BASE_ADDR #define'd in 'lib_cfg.h'; CANNOT #define to address
*0x0
*
*                   (2) Heap declared to Mem_Heap[] in 'lib_mem.c',       if
*LIB_MEM_CFG_HEAP_BASE_ADDR NOT #define'd in 'lib_cfg.h'
*********************************************************************************************************
*/
...
#define LIB_MEM_CFG_HEAP_BASE_ADDR                                             \
  0x00000000 /* Configure heap memory base address (see Note #2b).   */
#endif
...
*maximum number of significant digits to calculate &/or display for floating
