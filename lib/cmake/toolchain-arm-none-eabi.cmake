...
# Making device specific cmake modules visible
...
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--gc-sections --specs=nano.specs --specs=nosys.specs -mthumb -mabi=aapcs -Wl,-Map=.map" CACHE INTERNAL "Linker options")
...
#-------------------------------------------------------------------------------
# Creates output in elf format
#-------------------------------------------------------------------------------
function(create_elf_output TARGET)
    add_custom_target(${TARGET}.elf ALL DEPENDS ${TARGET} COMMAND ${CMAKE_OBJCOPY} ${TARGET} ${TARGET}.elf)
endfunction()
